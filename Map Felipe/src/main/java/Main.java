...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        nao.verbind("192.168.137.153",9559);
        ...
        while (true){
            ...
            try {
                ...
                switch (mqtt.readMsg().toLowerCase()) {
                    ...
                    case "armenoefening":
                        System.out.println("ARMEN OEFENING GEKLIKT");
                    ...
                    case "benenoefening":
                        System.out.println("BENEN OEFENING GEKLIKT");
                        reps = 12;
                        nao.Stand();
                    ...
                    case "oplevering":
                        System.out.println("OPLEVERING OEFENING GEKLIKT");
                        nao.Stand();
                        nao.Talk("Welkom bij deze demonstratie");
                        for (int i = 0; i < 2; i++) {
                            nao.Squat(2);
                            Thread.sleep(3000);
                            nao.Walk(1f, 0f, 0f);
